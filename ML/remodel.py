...
def data_capture():
    ...
    return raw_frames_type_1, raw_frames_type_2, raw_frames_type_3, raw_frames_type_4, rectangle_x1, rectangle_x2, rectangle_y1, rectangle_y2

def frame_processing(raw_frames_type_1, raw_frames_type_2, raw_frames_type_3, raw_frames_type_4, rectangle_x1, rectangle_x2, rectangle_y1, rectangle_y2):
...
def building_model(X, y):
    ...
    width, height = load_processing_images()
...
# Main function
def main():
    raw_frames_type_1, raw_frames_type_2, raw_frames_type_3, raw_frames_type_4, rectangle_x1, rectangle_x2, rectangle_y1, rectangle_y2 = data_capture()
    frame_processing(raw_frames_type_1, raw_frames_type_2, raw_frames_type_3, raw_frames_type_4, rectangle_x1, rectangle_x2, rectangle_y1, rectangle_y2)
    X, y = load_processing_images()
    model = building_model(X, y)
    model_evaluation(model, X, y)
    imgs = img_prediction()
    img_prediction(model, imgs)
