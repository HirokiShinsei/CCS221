...
for i in range(1, 6): # For loop to read a specific number of images to apply the transformations on.
    ...
    fig = plt.gcf()
    fig.canvas.manager.set_window_title('OpenCV Transformations') #This line sets the window title to OpenCV Transformations
