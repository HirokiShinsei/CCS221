...
init_cube = cube(side_length=5)
points_cube = tf.constant(init_cube, dtype=tf.float32)

init_triangular_prism = triangular_prism(side_length=5, height=5)
points = tf.constant(init_triangular_prism, dtype=tf.float32)

init_pyramid = pyramid(side_length=5, height=5)
points2 = tf.constant(init_pyramid, dtype=tf.float32)

init_rectangular_prism = rectangular_prism(length=5, width=3, height=4)
...
plt_basic_object(init_triangular_prism)
plt_basic_object(translated_triangular_prism)

st.write("Pyramid")
plt_basic_object(init_pyramid)
plt_basic_object(translated_pyramid)

st.write("Cube")
plt_basic_object(init_cube)
plt_basic_object(translated_cube)

st.write("Rectangular Prism")
plt_basic_object(init_rectangular_prism)
plt_basic_object(translated_rectangular_prism)
